...
export const ScenarioIcon = ({
  type,
}: ScenarioIconProps): React.JSX.Element => {
  const baseClass =
    'w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center mb-2 shadow-inner transition-transform hover:scale-105 flex-shrink-0';
  switch (type) {
    case 'scam':
      return (
